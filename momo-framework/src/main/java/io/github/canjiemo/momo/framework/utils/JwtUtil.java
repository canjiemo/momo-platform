...
public class JwtUtil {
    ...
    public String generateToken(String username, Long userId) {
        return generateTokenWithTenant(username, userId, null, null);
    }

    /**
     * 生成JWT Token（包含租户信息）
     */
    public String generateTokenWithTenant(String username, Long userId, Long tenantId, String tenantCode) {
