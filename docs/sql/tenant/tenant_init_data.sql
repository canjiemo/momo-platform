-- ====================================================================================================
-- 租户初始化数据 - DML (基础数据)
-- 说明：租户 Schema 创建后的基础数据（菜单、角色等）
-- 使用方式：
--   1. 在 tenant_schema_template.sql 执行完成后执行
--   2. Java 代码需要先切换到租户 Schema
--   3. 本脚本会插入默认的菜单和角色数据
-- 注意：
--   - 管理员用户由 Java 代码动态创建，不在此脚本中
--   - 可根据需要调整初始菜单和权限
-- 创建时间：2025-01-09
-- ====================================================================================================

-- 说明：完整的初始化数据请参考 docs/sql/data.sql
-- 这里仅包含基本的系统管理菜单和角色，实际使用时可根据需要调整
